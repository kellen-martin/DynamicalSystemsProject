...
def main():
    ...
    #v_0 = np.array([[0.0, 0.0, 0.0], [0, 29.783*10**3, 0], [0, 50*10**3 + 1022, 0]])
    #masses = np.array([1.989*10**30, 5.972*10**24, 7.342*10**22])
    t_0 = 0
    t_f = 86400*365
    h = 86400
    ...
    ax.plot(r_2[:,0],r_2[:,1],r_2[:,2], 'g--')
    ax.plot(r_3[:,0],r_3[:,1],r_3[:,2], 'k-')

    # plot starting points
    ax.plot(r_1[0,0],r_1[0,1],r_1[0,2],'y*')
    ax.plot(r_2[0,0],r_2[0,1],r_2[0,2], 'g*')
    ax.plot(r_3[0,0],r_3[0,1],r_3[0,2], 'k*')
